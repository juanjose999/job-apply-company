...
public class CompanyServiceImpl implements ICompanyService{
    ...
    @Override
    public CompanyResponseDto findCompanyByEmail(String email) {
        return CompanyMapper.CompanyToCompanyResponseDto(
    ...
    @Override
    public CompanyResponseDto updateCompanyByEmail(FormUpdateCompany formUpdateCompany) {
        return CompanyMapper.CompanyToCompanyResponseDto(
                companyRepository.updateCompanyByEmail(
                        formUpdateCompany.email(), CompanyMapper.CompanyDtoToCompany(formUpdateCompany.companyDto())));
    }
